...
class NN(object):
    ...
    def train(self):
        ...
        _a[0] = tf.compat.v1.placeholder("float", [None, self._X.shape[1]])
        y = tf.compat.v1.placeholder("float", [None, self._Y.shape[1]])
        ...
        train_op = tf.compat.v1.train.MomentumOptimizer(self._learning_rate, self._momentum).minimize(cost)
        
        #Prediction operation
        predict_op = tf.compat.v1.argmax(_a[-1], 1)
